...
const Experience = () => {
  return (
    <div id="experiencia" className="relative py-32">
              ...
              {experiences.map((exp, i) => {
                ...
                return (
                  ...
                  >
                        ...
                        <div className="glass-card p-6 hover:border-primary/40 hover:-translate-y-1 transition-all duration-500">
                          ...
                          <ul className="flex flex-wrap gap-2 md:justify-end">
                            {exp.highlights.map((highlight) => (
                              <li key={highlight} className="text-[11px] font-mono px-2.5 py-1 rounded-full bg-primary/10 border border-primary/20">
                                {highlight}
                              </li>
                            ))}
                          </ul>
                    ...
                    <div className={!isLeft ? 'pl-20 md:pl-12' : 'hidden mb:block'}>
                      {!isLeft && (
                        <div className="glass-card p-6 hover:border-primary/40 hover:-translate-y-1 transition-all duration-500">
                          <p className="font-mono text-[11px] text-accent uppercase tracking-widest mb-2">
                            { exp.period }
                          ...
                          <p className="text-primartext-primary-glow font-medium mb-3">{exp.company}</p>
